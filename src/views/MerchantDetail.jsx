    ...
    <>
      <section className="merchant">
        ...
        <div className="merchant-text">
          ...
          <p className="merchant-distance">1km</p>
          <p className="merchant-description">{merchant?.description}</p>
          <p className="merchant-status">10.00 am - 19.00 pm</p>
          ...
          <FaInstagram className="btn-socmed"/> <FaTiktok className="btn-socmed"/> <FaWhatsapp className="btn-socmed"/>
          </div>
